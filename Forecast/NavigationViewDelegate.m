...
#import "FlipTransitioning.h"
@interface NavigationViewDelegate()
@property (nonatomic,strong) FlipTransitioning            *flipTransitioning;
...
@end
@implementation NavigationViewDelegate
- (void)dealloc
{
...
- (void)commonInit
{
    ...
    _flipTransitioning = [[FlipTransitioning alloc] init];
